...
sudo_users = {SUDO,1019610884,11,1106781321,1282382975}   
...
local UserName = (data.username_ or "SoUrceMaTriX")
...
usertext = '\n ✧ العضو » ['..result.title_..'](t.me/'..(username or 'SoUrceMaTriX')..')'
status  = '\n ✧ تم ترقيته مطور'
...
usertext = '\n ✧ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SoUrceMaTriX')..')'
status  = '\n ✧ تم ترقيته مطور'
...
if MATRIX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✧ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SoUrceMaTriX')..') \n ✧ '..MATRIX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✧ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SoUrceMaTriX')..') \n ✧ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✧ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SoUrceMaTriX')..') \n ✧ تـم قفـل التاك بالكتم ')
end,nil)   
...
local TextE = "\n♡♡ᴍᴀᴛʀɪх♡♡\n ✧ علامة تعني { ✓ } ملف مفعل\n ✧ علامة تعني { ✘ } ملف معطل\n ✧ قناة سورس ماتركس ↓\n".." ✧ [اضغط هنا لدخول](t.me/SoUrceMaTriX) \n"
local NumFile = 0
...
local UserName = (b.username_ or "SoUrceMaTriX")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✧ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SoUrceMaTriX')..')'
status  = '\n ✧ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✧ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✧ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SoUrceMaTriX')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✧ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SoUrceMaTriX')..')'..'\n ✧ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SoUrceMaTriX')..')'
local iduser = result.sender_user_id_
